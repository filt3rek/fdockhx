...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("ftb", "FDockHxNME", "ftb.app.fdockhx", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("ftb.app.fdockhx.FDock");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (ftb.app.fdockhx.FDock)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (ftb.app.fdockhx.FDock, Reflect.field (ftb.app.fdockhx.FDock, "main"), []);
...
@:keep class DocumentClass extends ftb.app.fdockhx.FDock { }
